...
<head>
  ...
  <title>MLOps - Object detection page</title>
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Treatment of images and videos Detection of objects</h2>
          <ol>
            <li><a href="index">Homepage</a></li>
            <li>Treatment of images and videos Detection of objects</li>
            <li></li>
          </ol>
        </div>
      ...
      <div class="container">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              @if ($message = Session::get('successOD'))
              <div class="row mb-5">
              ...
              <div class="cold-md-12">
                <div class="col-md-6" >
                  ...
                  <img src="/{{ Session::get('imageOD') }}?={{Date('U')}}" style="width: 450px">
                  @else
                  <video width="450" height="250" controls>
                    <source src="/{{ Session::get('imageOD') }}?={{Date('U')}}" type="video/mp4">
                  </video>
    ...
    <section class="service-details" data-aos="fade-up">
        ...
        <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title"><a href="traitement-image-detection-genre-&-visage">Treatment of facial and gender images</a></h5>
              <p class="card-text">This module will allow you to analyze your images in order to detect the faces and the gender of the person</p>
